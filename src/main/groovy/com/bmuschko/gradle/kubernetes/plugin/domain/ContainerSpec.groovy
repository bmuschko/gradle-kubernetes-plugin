...
class ContainerSpec {
     ...
     */  
    ContainerSpec withVolumeMount(String mountName, String mountPath) {
     ...
     */  
    ContainerSpec withPorts(Integer containerPort, @Nullable Integer hostPort) {
     ...
     */  
    ContainerSpec withExecProbe(@Nullable Integer periodSeconds,
     ...
     */  
    ContainerSpec withHttpProbe(@Nullable Integer periodSeconds,
                            @Nullable Integer initialDelaySeconds,
                            @Nullable Integer timeoutSeconds,
                            String path,
