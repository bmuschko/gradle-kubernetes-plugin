 ...
 * Delete a deployment.
 */
class DeleteDeployment extends AbstractKubernetesTask {
    ...
    def handleClient(kubernetesClient) {
        ...
        if (!localResponse) {
            throw new GradleException("Failed deleting deployment")
        }
    ...
    def applyInputs(obj) {
        ...
        invokeMethod(objRef, 'withName', deployment)
