...
/**
 *
 * All functional tests for the `DeleteDeployment` task.
 *
 */
class DeleteDeploymentFunctionalTest extends AbstractFunctionalTest {

    def "Delete non-existent deployment"() {
        ...
        buildFile << """
            ...
            task workflow(dependsOn: deleteDeployment)
        """
    ...
    def "Delete non-existent deployment with config"() {
